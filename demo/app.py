...
# Short list, but generated by a rule rather than hand-picked: the first five
# integers, plus the two seeds that appear in write-ups. A list assembled by
# eye would quietly bake outcome selection into the UI; "0,1,2,3,4" cannot have
...
st.sidebar.caption(
    "The list is the first five integers plus two documented seeds; pick "
